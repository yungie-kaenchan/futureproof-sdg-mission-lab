/**
 * FUTUREPROOF — SDG 11 Bangkok — "The Klong and the City" Mission
 *
 ...
 *
 *   2. KEYSTONE ON PASS — completing the mission awards the SDG-11
...
const MISSION_ID = "sdg11-bangkok"; // must match keystones.js JOURNEY_MISSIONS id

/* Resolved once at mission start so every phase renders at the same tier. */
let READING_TIER = 2;

export function installBangkokMission(engine) {
...
export const installBangkokMission1 = installBangkokMission;
  ...
  paint(container, `
    <section class="mission-complete">
      <div class="complete-banner">
        ...
        <h2 class="display-heading text-3xl mt-2">${passed ? "The Klong and the City — cleared." : "Close. One more pass."}</h2>
        <p class="body-l text-on-surface-variant mt-2">
          ${passed
      ...
      <div class="complete-stats">
        ...
        <div class="complete-stat">
          <div class="console-label-gold">SDG 11 KEYSTONE</div>
